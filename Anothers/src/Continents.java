public class Continents{
    ...
    public static void main(String[] args){
        int continent = 4;
        switch(continent){
            case 1: System.out.println("North America: Mexice City, Mexico.");
                break;
            case 2: System.out.println("South America: Sao Paulo, Breazil.");
                break;
            case 3: System.out.println("Europe: Moscow, Russia.");
                break;
            case 4: System.out.println("Africa: Lagos, Nigeria.");
                break;
            case 5: System.out.println("Asia Shangai, China.");
                break;
